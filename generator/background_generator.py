...
def image(height: int, width: int, image_dir: str) -> Image:
    ...
    if len(images) > 0:
        ...
        if rnd.random() < 0.5:
            scale_factor = 1.2
            scale_width = width * scale_factor / pic.size[0]
            scale_height = height * scale_factor / pic.size[1]
            ...
            # Resize strategy: Resize image to at least 1.2 times the dimensions, maintaining aspect ratio
